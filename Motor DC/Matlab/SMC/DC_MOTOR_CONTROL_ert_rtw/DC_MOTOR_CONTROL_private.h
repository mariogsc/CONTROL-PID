...
#ifndef RTW_HEADER_DC_MOTOR_CONTROL_private_h_
#define RTW_HEADER_DC_MOTOR_CONTROL_private_h_
#include "rtwtypes.h"
...
extern void DC_MOTOR_CONTROL_derivatives(void);

#endif                              /* RTW_HEADER_DC_MOTOR_CONTROL_private_h_ */
